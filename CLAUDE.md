...
Single Node.js process that connects to WhatsApp/Telegram, routes messages to Claude Agent SDK running as native Node.js subprocesses. Each group has isolated filesystem and memory.
